...
const METHODS: {
...
}[] = [
  {
    ...
    short: 'UPI / Cards / Netbanking',
    sub: 'Razorpay secure checkout',
    ic: 'RZP',
    available: true,
  },
  {
    key: 'card',
    label: 'Saved card •••• 4821',
    short: 'Card ••4821',
    sub: 'VISA · 11/29',
    ic: '💳',
    available: false,
  ...
  {
    key: 'wallet',
    label: 'Findemy wallet',
    short: 'Findemy wallet',
    sub: '₹0 balance',
    ic: '₹',
    available: false,
  },
  ...
  return (
    <>
      ...
      >
        ...
        >
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
            <Text
              style={{ fontFamily: theme.font.sansSemibold, fontSize: 12, color: theme.color.mist }}
            >
              Pay using
            </Text>
        ...
        <Pressable
          ...
          style={[
            styles.pill,
            { backgroundColor: theme.color.persimmon, opacity: disabled || loading ? 0.6 : 1 },
          ]}
        >
          {loading ? (
            ...
            <>
              ...
              <Text style={{ fontFamily: theme.font.sansBold, fontSize: 15, color: '#fff' }}>
                {ctaLabel} ›
              </Text>
            </>
          )}
      ...
      <Modal
        ...
        transparent
        animationType="slide"
        onRequestClose={() => setShowMethods(false)}
      >
              ...
              <Pressable
                ...
                style={[
                  styles.method,
                  {
                    ...
                    backgroundColor: '#fff',
                    opacity: methodOption.available ? 1 : 0.5,
                  },
                ]}
              >
