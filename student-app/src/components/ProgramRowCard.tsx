...
export function ProgramRowCard({ program, onPress }: Props) {
  ...
  const monthly = program.monthly_fee_paise_from > 0 ? ` · ${rupees(program.monthly_fee_paise_from)}/mo` : "";
  ...
  return (
    ...
    >
      <Image source={{ uri: program.image_url }} style={styles.thumb} contentFit="cover" transition={150} />
