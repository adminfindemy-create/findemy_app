...
const WORKSHOP_BY_TYPE: Record<string, string> = {
  masterclass: "https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=600&q=80&auto=format",
...
const EVENT_BY_TYPE: Record<string, string> = {
  competition:  "https://images.unsplash.com/photo-1429962714451-bb934ecdc4ec?w=600&q=80&auto=format",
  talent_hunt:  "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=600&q=80&auto=format",
  reel_battle:  "https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?w=600&q=80&auto=format",
