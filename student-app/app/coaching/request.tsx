...
import { Button, Chip, DateTimePicker, Input, useTheme } from '@findemy/ui';
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.color.paper }} edges={['top']}>
      ...
      >
        ...
        >
          The academy will review your request and quote a price for the session. You'll only be
          asked to pay once they accept.
        </Text>
