...
import { useTheme, IconCal, IconShield } from "@findemy/ui";
...
export default function CoachingPayScreen() {
	...
	const { booking_id, razorpay_order_id, razorpay_key, amount_paise, coach_name, mode, proposed_at } =
			...
			<ScrollView contentContainerStyle={{ paddingHorizontal: 18, paddingBottom: 130 }} showsVerticalScrollIndicator={false}>
				...
				<View style={[styles.card, { backgroundColor: theme.color.paperWarm, borderColor: theme.color.hairline }]}>
					...
					<View style={styles.lineRow}>
						<Text style={{ fontFamily: theme.font.sansSemibold, fontSize: 14, color: theme.color.ink }}>1 × Coaching session</Text>
