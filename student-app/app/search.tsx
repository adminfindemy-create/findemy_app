...
import { useTheme, IconButton, IconChevL, IconSearch, IconX } from "@findemy/ui";
      ...
      >
        {trimmedQuery.length === 0 ? (
          <View style={styles.prompt}>
            <Text style={{ fontFamily: theme.font.sansMedium, fontSize: 14, color: theme.color.mist, textAlign: "center" }}>
