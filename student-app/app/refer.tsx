...
import { useClaimReferral, useReferral, useReferralHistory } from '@/hooks/useReferral';
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 60 }}>
        ...
        >
          ...
          <View style={{ flexDirection: 'row', gap: 10, marginTop: 16 }}>
            <Button variant="ink" size="sm" onPress={handleShare} style={{ minWidth: 100 }}>
              Share
            </Button>
            <Button variant="ghost" size="sm" onPress={handleCopy} style={{ minWidth: 100 }}>
              Copy
            </Button>
          </View>
        </View>
          ...
          <View style={{ paddingHorizontal: 24, marginTop: 24 }}>
            ...
            {history.map((referral: any) => (
              ...
              >
                <View style={{ flex: 1 }}>
                  <Text
                    style={{ fontFamily: theme.font.sans, fontSize: 14, color: theme.color.ink }}
                  >
                    {referral.referree_name}
                  </Text>
                  {referral.claimed_at && (
                    <Text
                      style={{
                    ...
                    >
                      {new Date(referral.claimed_at).toLocaleDateString('en-IN', {
                        day: 'numeric',
                        month: 'short',
                        year: 'numeric',
                      })}
