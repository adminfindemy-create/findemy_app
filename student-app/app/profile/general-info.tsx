...
import { IconChevR, IconEdit, IconHelp, IconShield, IconSparkle, useTheme } from '@findemy/ui';
  ...
  const items = [
    {
      ...
      onPress: () =>
        Alert.alert('Terms & Conditions', 'Our terms of service will be available soon.'),
    },
    {
    ...
    },
    {
      ...
      onPress: () =>
        Alert.alert(
          'About Findemy',
          'Findemy connects students with top music, dance, yoga, and art academies near them.'
        ),
    },
    {
      label: 'Help & Support',
      ...
      onPress: () =>
        Alert.alert('Help & Support', 'Our support team is here for you. Coming soon.'),
    },
  ];
