import { IconCheck, sansFor, useTheme } from '@findemy/ui';
...
function fmtTime(marked_at?: string): string | null {
  ...
  if (Number.isNaN(d.getTime())) return marked_at;
    ...
    <View style={{ gap: 12 }}>
      <View style={styles.badgeRow}>
        ...
        <View
          style={[
            styles.badge,
            { backgroundColor: record ? theme.color.roseSoft : theme.color.paperWarm },
          ]}
        >
          <Text
            style={[styles.badgeText, { color: record ? theme.color.rose : theme.color.inkSoft }]}
          >
            ...
            >
              ...
              {row.checked_in ? (
                <View style={[styles.chk, { backgroundColor: theme.color.jadeSoft }]}>
                  ...
                  <Text style={[styles.chkText, { color: theme.color.jade }]}>
                    {record ? 'Present' : 'In'}
                  </Text>
                </View>
              ) : (
                ...
                >
                  <Text
                    style={[
                      styles.chkText,
                      { color: record ? theme.color.rose : theme.color.whisper },
                    ]}
                  >
