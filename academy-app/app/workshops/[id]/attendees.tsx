...
import { IconPhone, IconWa, sansFor, useTheme } from '@findemy/ui';
...
function Row({ registrant }: { registrant: Registrant }) {
  ...
  const openWhatsApp = () => {
    ...
    const msg = encodeURIComponent(
      `Hi ${registrant.user.name}, this is about your workshop booking.`
    );
  ...
  return (
    ...
    >
      <View style={[styles.avatar, { backgroundColor: theme.color.persimmon }]}>
        <Text
          style={{ fontFamily: theme.font.serifItalic, fontSize: 15, color: theme.color.ivory }}
        >
      ...
      <View style={{ flex: 1, minWidth: 0 }}>
        ...
        <Text
          style={{ fontFamily: sansFor(600), fontSize: 12, color: theme.color.mist, marginTop: 2 }}
          numberOfLines={1}
        >
      ...
      {phone ? (
        <>
          <Pressable
            onPress={call}
            style={[styles.act, { backgroundColor: theme.color.paperWarm }]}
            hitSlop={6}
          >
          ...
          <Pressable
            ...
            style={[styles.act, { backgroundColor: '#25D366' }]}
            hitSlop={6}
          >
          ...
          ListHeaderComponent={
            data?.workshop && rows.length > 0 ? (
              ...
              >
                ...
                {data.workshop.registered_count} of {data.workshop.capacity} seats
              </Text>
            ) : null
          }
          ListEmptyComponent={
