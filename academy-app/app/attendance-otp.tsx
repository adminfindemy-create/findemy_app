      ...
      <Screen header={<ScreenHeader title="Verify attendance" showBack />} bottomTab={null}>
        <View style={[styles.center, { backgroundColor: theme.color.paperWarm }]}>
          ...
          <View style={{ marginTop: 24 }}>
            <Button onPress={() => router.replace('/(tabs)/inbox')}>
              Back to inbox
            </Button>
          </View>
        </View>
  ...
  return (
    <Screen header={<ScreenHeader title="Attendance" showBack />} bottomTab={null}>
      <View style={styles.container}>
        {/* Session recap */}
        {trial ? (
          <View style={[styles.recap, { backgroundColor: theme.color.ivory, borderColor: theme.color.hairline }]}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={{ fontFamily: sansFor(600), fontSize: 12.5, color: theme.color.mist, marginTop: 2 }}>
        ...
        <Pressable onPress={onNoShow} style={{ marginTop: 18 }} disabled={noShow.isPending}>
          <Text style={{ textAlign: 'center', color: theme.color.rose, fontFamily: sansFor(700), fontSize: 13 }}>
