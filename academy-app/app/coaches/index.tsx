...
import { Button, IconChevR, IconPlus, sansFor, useTheme } from '@findemy/ui';
      ...
      <View style={styles.container}>
        {isLoading ? (
          ...
          <View style={{ paddingVertical: 24, alignItems: 'center', gap: 12 }}>
            ...
            <Button variant="primary" onPress={() => router.push('/coaches/new')}>
              Add first coach
            </Button>
          </View>
        ) : (
                ...
                >
                  ...
                  <View style={{ flex: 1, minWidth: 0 }}>
                    ...
                    >
                      {[
                        coach.specialty,
                        typeof coach.batch_count === 'number'
                          ? `${coach.batch_count} batch${coach.batch_count === 1 ? '' : 'es'}`
                          : null,
                      ]
                        .filter(Boolean)
                        .join(' · ')}
